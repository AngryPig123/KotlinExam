...
//    personList.groupBy { it.age }.let { it.forEach { (t, u) -> System.err.println("$t :: $u") } }
    ...
    personList.filter { it.age == personList.maxBy { it -> it.age }!!.age }
        .let { it.forEach { it -> System.err.println(it) } }

//    groupBy 리스트를 여러 그룹으로 이뤄진 맵으로 변경.
    personList.groupBy { it.age }
        .let { it -> it.forEach { (t, u) -> System.err.println("$t :: $u") } }
